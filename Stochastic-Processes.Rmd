...
b) From Figure 2, we can deduce that States 4 ad 5 are transient, because once the system move from state four to state 1, it can no longer return to states 4 and 5. \newline
Also, we see that States 1, 2 and 3 are recurent, and 
